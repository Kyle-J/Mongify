...
Mongify.prototype.attachResourceRoutes = function (server) {
    ...
    server.opts({ path: '/:resource/', version: Mongify.prototype.apiVersion}, function(request, response) {
        response.statusCode = 200;
        response.header('Access-Control-Allow-Origin', response.headers.origin);
...
Mongify.prototype.read = function (request, response) {
    ...
    // TODO: Where shall i put this??
    if(request.params.authorised_tenant_id) resource.state.tenant_id = request.params.authorised_tenant_id;
                ...
                if (error) {
                    ...
                    Async.series([
                        ...
                        function (next) {
                            ...
                            // TODO: Get next and previous need to concider tenant_id as well
...
Mongify.prototype.add = function (request, response) {
    ...
    Async.series([
        ...
        function (callback) {
            ...
            resource = Mongify.prototype.getResource(request.params.resource, 'singular', response)
        ...
        function() {
            ...
            Async.forEach(Object.keys(request.params), function (param, next) {
                 ...
                 * Setup document defaults
                 */
                data['tenant_id']   = data.authorised_tenant_id
