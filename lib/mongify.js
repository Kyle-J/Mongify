...
Mongify.prototype.addResource = function (request, response) {
    ...
    Async.forEach(Object.keys(request.params), function (param, next) {
        ...
        document['deleted_on']  = null // TODO : set to 000
        document['enabled']     = 1
...
Mongify.prototype.updateResource = function (request, response) {

    // TODO: Replace Lingo - No contributions for too long MAYBE USE MONGOOSE UTILS BUT NEED INJECTING PROPERLY

    var identifier = Mongify.prototype.database.Types.ObjectId(request.params.identifier)

    var resource = Mongify.prototype.getResourceObject(request.params.resource)
...
Mongify.prototype.getResourceObject = function (resource_name) {
     ...
     * Setup variables
     */
    var resource_name = english.pluralize(resource_name.toLowerCase())
...
Mongify.prototype.attachResourceRoutes = function (server, callback) {
    ...
    server.put({path: '/:resource/:identifier', version: Mongify.prototype.apiVersion}, Mongify.prototype.updateResource)
    callback()
